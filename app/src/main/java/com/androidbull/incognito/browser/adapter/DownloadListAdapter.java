...
import com.androidbull.incognito.browser.core.utils.MimeTypeUtils;
           ...
           int resId;
            switch (MimeTypeUtils.getCategory(item.info.mimeType)) {
                case DOCUMENT:
                    ...
                    break;
                case IMAGE:
                    resId = R.drawable.ic_image_grey_24dp;
                    break;
                case VIDEO:
                    resId = R.drawable.ic_video_grey600_24dp;
                    break;
                case APK:
                    resId = R.drawable.ic_android_grey_24dp;
                    break;
                case AUDIO:
                    resId = R.drawable.ic_music_note_grey_24dp;
                    break;
                case ARCHIVE:
