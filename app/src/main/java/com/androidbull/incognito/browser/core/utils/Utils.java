...
import com.androidbull.incognito.browser.core.RealSystemFacade;
...
import static com.androidbull.incognito.browser.core.utils.MimeTypeUtils.DEFAULT_MIME_TYPE;
import static com.androidbull.incognito.browser.core.utils.MimeTypeUtils.MIME_TYPE_DELIMITER;
...
//TODO fix these
    public static final String DEFAULT_NOTIFY_CHAN_ID = "com.androidbull.incognito.browser.DEFAULT_NOTIFY_CHAN";
    public static final String FOREGROUND_NOTIFY_CHAN_ID = "com.androidbull.incognito.browser.FOREGROUND_NOTIFY_CHAN";
    public static final String ACTIVE_DOWNLOADS_NOTIFY_CHAN_ID = "com.androidbull.incognito.browser.CTIVE_DOWNLOADS_NOTIFY_CHAN";
    public static final String PENDING_DOWNLOADS_NOTIFY_CHAN_ID = "com.androidbull.incognito.browser.PENDING_DOWNLOADS_NOTIFY_CHAN";
    public static final String COMPLETED_DOWNLOADS_NOTIFY_CHAN_ID = "com.androidbull.incognito.browser.COMPLETED_DOWNLOADS_NOTIFY_CHAN";
  ...
  /*  public static void reportError(@NonNull Throwable error,
                                                             ...
                                                             @NonNull SharedPreferences localPref)
    {
        ...
        category.items.add(new DrawerGroupItem(res.getInteger(R.integer.drawer_category_all_id),
                R.drawable.ic_all_inclusive_grey_24dp, res.getString(R.string.all)));
        ...
        category.items.add(new DrawerGroupItem(res.getInteger(R.integer.drawer_category_images_id),
                R.drawable.ic_image_grey_24dp, res.getString(R.string.drawer_category_images)));
        ...
        category.items.add(new DrawerGroupItem(res.getInteger(R.integer.drawer_category_apk_id),
                R.drawable.ic_android_grey_24dp, res.getString(R.string.drawer_category_apk)));
        category.items.add(new DrawerGroupItem(res.getInteger(R.integer.drawer_category_audio_id),
                R.drawable.ic_music_note_grey_24dp, res.getString(R.string.drawer_category_audio)));
