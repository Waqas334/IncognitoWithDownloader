...
/*
*This class is not being used anywhere but not deleted it as it has to be implemented in the next iteration
*
* TODO NEXT Iteration: make a combine Settings for Downloader and Browser
 */
