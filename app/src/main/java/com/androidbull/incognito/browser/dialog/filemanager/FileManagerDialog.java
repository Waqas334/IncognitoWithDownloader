...
import com.androidbull.incognito.browser.adapter.filemanager.FileManagerAdapter;
...
import com.androidbull.incognito.browser.dialog.ErrorReportDialog;
import com.androidbull.incognito.browser.viewmodel.filemanager.FileManagerViewModel;
import com.androidbull.incognito.browser.viewmodel.filemanager.FileManagerViewModelFactory;
import com.androidbull.incognito.databinding.ActivityFilemanagerDialogBinding;
        ...
        switch (event.type) {
            case POSITIVE_BUTTON_CLICKED:
                if (event.dialogTag.equals(TAG_INPUT_NAME_DIALOG) && inputNameDialog != null) {
                    ...
                    //TODO ERROR REPORTING EDITED HERE
//                    if (dialog != null) {
