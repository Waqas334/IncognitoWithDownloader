...
package com.androidbull.incognito.browser.service;
...
import com.androidbull.incognito.browser.core.ChangeableParams;
import com.androidbull.incognito.browser.core.DownloadEngine;
import com.androidbull.incognito.browser.core.DownloadEngineListener;
...
public class DownloadService extends LifecycleService
{
    ...
    public static final String ACTION_SHUTDOWN = "com.androidbull.incognito.browser.service.DownloadService.ACTION_SHUTDOWN";
    public static final String ACTION_RUN_DOWNLOAD = "com.androidbull.incognito.browser.service.ACTION_RUN_DOWNLOAD";
    public static final String ACTION_CHANGE_PARAMS = "com.androidbull.incognito.browser.service.ACTION_CHANGE_PARAMS";
    ...
    {
        /* For starting download_menu activity */
        Intent startupIntent = new Intent(getApplicationContext(), DownloadMainActivity.class);
